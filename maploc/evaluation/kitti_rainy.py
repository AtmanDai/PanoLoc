...
from .. import logger
from ..data import KittiRainyDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiRainyDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiRainyDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiRainyDataModule(cfg.get("data", {}))

...
from .. import logger
from ..data import KittiMixDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiMixDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiMixDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiMixDataModule(cfg.get("data", {}))

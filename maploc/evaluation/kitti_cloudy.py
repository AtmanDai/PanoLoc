...
from .. import logger
from ..data import KittiCloudyDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiCloudyDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiCloudyDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiCloudyDataModule(cfg.get("data", {}))

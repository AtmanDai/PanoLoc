...
#SBATCH --job-name=mgl_snowy_sanfrancisco
#SBATCH --output=mgl_snowy_sanfrancisco_%j.out
#SBATCH --error=mgl_snowy_sanfrancisco_%j.err
...
PYTHON_SCRIPT_PATH="/hkfs/work/workspace/scratch/tj3409-rdaionet/OrienterNet/image_generation/mgl_snowy.py"
SCENE="sanfrancisco"

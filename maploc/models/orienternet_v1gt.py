...
class OrienterNet(BaseModel):
    ...
    def _forward(self, data):
        ...
        if is_panorama and self.conf.fusion_strategy == "pano_prior":
        ...
        scores_view1_log_probs = log_softmax_spatial(scores_view1.permute(0, 2, 3, 1)) # Shape: [B/3, H, W, N_rot]

        # --- Stage 3: Fuse the sharp yaw scores with the robust xy prior.
        fused_scores = scores_view1_log_probs + xy_log_heatmap.unsqueeze(-1)

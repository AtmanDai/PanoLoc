...
from .. import logger
from ..data import KittiFoggyDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiFoggyDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiFoggyDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiFoggyDataModule(cfg.get("data", {}))

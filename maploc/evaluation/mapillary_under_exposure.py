...
from ..data import MapillaryUnderExposureDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_under_exposure.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryUnderExposureDataModule(cfg.get("data", {}))

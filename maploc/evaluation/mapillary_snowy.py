...
from ..data import MapillarySnowyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_snowy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillarySnowyDataModule(cfg.get("data", {}))

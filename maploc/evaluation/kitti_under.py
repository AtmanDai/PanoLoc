...
from .. import logger
from ..data import KittiUnderExposureDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiUnderExposureDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiUnderExposureDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiUnderExposureDataModule(cfg.get("data", {}))

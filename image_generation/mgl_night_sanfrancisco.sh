...
#SBATCH --job-name=mgl_night_sanfrancisco
#SBATCH --output=mgl_night_sanfrancisco_%j.out
#SBATCH --error=mgl_night_sanfrancisco_%j.err
...
PYTHON_SCRIPT_PATH="/hkfs/work/workspace/scratch/tj3409-rdaionet/OrienterNet/image_generation/mgl_night.py"
SCENE="sanfrancisco"

...
from ..data import MapillaryOverExposureDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_over_exposure.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryOverExposureDataModule(cfg.get("data", {}))

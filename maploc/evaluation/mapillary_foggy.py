...
from ..data import MapillaryFoggyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_foggy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryFoggyDataModule(cfg.get("data", {}))

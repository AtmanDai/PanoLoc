...
from ..data import MapillaryNightDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_night.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryNightDataModule(cfg.get("data", {}))

...
from ..data import MapillaryPanoDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_washington.yaml")
data_cfg = OmegaConf.merge(
    data_cfg_train,
    {
        ...
        "add_map_mask": True,
        "max_init_error": 32,
        "loading": {"val": {"batch_size": 4, "num_workers": 4}},
    },
)
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryPanoDataModule(cfg.get("data", {}))

...
from .. import logger
from ..data import KittiMotionBlurDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiMotionBlurDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiMotionBlurDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiMotionBlurDataModule(cfg.get("data", {}))

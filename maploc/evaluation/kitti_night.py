...
from .. import logger
from ..data import KittiNightDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiNightDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiNightDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiNightDataModule(cfg.get("data", {}))

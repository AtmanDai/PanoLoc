...
from .. import logger
from ..data import KittiOverExposureDataModule
...
default_cfg_sequential = OmegaConf.create(
    {
        "data": {
            "mask_radius": KittiOverExposureDataModule.default_cfg["max_init_error"],
            "prior_range_rotation": KittiOverExposureDataModule.default_cfg[
...
def run(
    ...
    **kwargs,
    ...
    dataset = KittiOverExposureDataModule(cfg.get("data", {}))

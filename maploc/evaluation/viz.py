...
def plot_example_pano(
    ...
    map_viz = Colormap.apply(rasters)
    map_viz_v2 = Colormap.apply(rasters_v2)
    map_viz_v3 = Colormap.apply(rasters_v3)
    overlay = likelihood_overlay(prob.numpy(), map_viz.mean(-1, keepdims=True))
    plot_images(
        [image, map_viz, overlay, feats_map_rgb],
        titles=[f"View 1 - {text1}", "map", "likelihood", "neural map"],
        dpi=75,
        cmaps="jet",
    )
    fig = plt.gcf()
    ...
    plot_images(
        [image, map_viz, image_v2, map_viz_v2, image_v3, map_viz_v3],
        titles=["View1", "map1", "View2", "map2", "View3", "map3"],
        dpi=75,
        cmaps="jet",
    )
    plt.show()
    ...
    if "features_bev_individual" in pred:
        ...
        plot_images(
            ...
            titles=["View 1 (0°)", "View 2 (120°)", "View 3 (240°)"],
            dpi=50,
            cmaps="jet",
        )
        plt.show()

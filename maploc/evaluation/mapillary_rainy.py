...
from ..data import MapillaryRainyDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_rainy.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryRainyDataModule(cfg.get("data", {}))

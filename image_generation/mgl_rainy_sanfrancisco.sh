...
#SBATCH --job-name=mgl_rainy_sanfrancisco
#SBATCH --output=mgl_rainy_sanfrancisco_%j.out
#SBATCH --error=mgl_rainy_sanfrancisco_%j.err
...
PYTHON_SCRIPT_PATH="/hkfs/work/workspace/scratch/tj3409-rdaionet/OrienterNet/image_generation/mgl_rainy.py"
SCENE="sanfrancisco"

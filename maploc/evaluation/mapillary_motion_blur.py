...
from ..data import MapillaryMotionBlurDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "mapillary_motion_blur.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = MapillaryMotionBlurDataModule(cfg.get("data", {}))
